...
#ifndef EDHOC_CLIENT_HANDSHAKE_MESSAGE_3_ERRORS_H_
#define EDHOC_CLIENT_HANDSHAKE_MESSAGE_3_ERRORS_H_

#include "common/data_models.h"

/**
 * @brief Compose EDHOC error payload for Message 3 operation failures.
 *
