...
coap_pdu_code_t com_coap_map_parse_result_to_pdu_code(
  ...
  switch (status) {
  case COM_COAP_PARSE_EDHOC_REQ_OK:
    return COAP_RESPONSE_CODE_CHANGED;

  case COM_COAP_PARSE_EDHOC_REQ_ERR_MISSING_FORMAT:
  case COM_COAP_PARSE_EDHOC_REQ_ERR_UNSUPPORTED_FORMAT:
  case COM_COAP_PARSE_EDHOC_REQ_ERR_NO_PAYLOAD:
    return COAP_RESPONSE_CODE_BAD_REQUEST;

  case COM_COAP_PARSE_EDHOC_REQ_ERR_PDU:
  case COM_COAP_PARSE_EDHOC_REQ_ERR_DATA_BUFFER:
