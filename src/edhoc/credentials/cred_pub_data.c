...
const uint8_t CRED_EDHOC_PUB_CLI_PK[CRED_EDHOC_PUB_PK_LENGTH] = {
...
const uint8_t CRED_EDHOC_PUB_SRV_PK[CRED_EDHOC_PUB_PK_LENGTH] = {
...
const int32_t CRED_EDHOC_PUB_SRV_KID = 20;
const int32_t CRED_EDHOC_PUB_CLI_KID = 18;
const uint16_t CRED_EDHOC_PUB_SRV_PORT = 8080;
const char CRED_EDHOC_PUB_SRV_URI[] = "127.0.0.1";