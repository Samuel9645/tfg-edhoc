...
const uint8_t EDH_CRED_PUB_SRV_PK[EDH_CRED_PUB_PK_LENGTH] = {
...
const int32_t EDH_CRED_PUB_SRV_KID = 20;
const int32_t EDH_CRED_PUB_CLI_KID = 18;
const uint16_t EDH_CRED_PUB_SRV_PORT = 8080;
const char EDH_CRED_PUB_SRV_URI[] = "127.0.0.1";