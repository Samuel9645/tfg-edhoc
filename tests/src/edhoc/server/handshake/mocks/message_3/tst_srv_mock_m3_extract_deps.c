...
int tst_srv_edhoc_message_3_extract_stub_extract_result = EDHOC_SUCCESS;
bool tst_srv_edhoc_message_3_extract_stub_equal_result = true;
...
void tst_srv_edhoc_message_3_extract_reset_stub_results(void) {
  tst_srv_edhoc_message_3_extract_stub_extract_result = EDHOC_SUCCESS;
  tst_srv_edhoc_message_3_extract_stub_equal_result = true;
...
void tst_srv_m3_extract_set_extraction_failure(void) {
  tst_srv_edhoc_message_3_extract_stub_extract_result =
      EDHOC_ERROR_GENERIC_ERROR;
}

void tst_srv_m3_extract_set_cid_mismatch(void) {
  tst_srv_edhoc_message_3_extract_stub_equal_result = false;
}

void tst_srv_m3_extract_set_success_data(
...
int edhoc_extract_connection_id(
  ...
  if (tst_srv_edhoc_message_3_extract_stub_extract_result == EDHOC_SUCCESS &&
      extracted_fields != NULL) {
    *extracted_fields = tst_srv_edhoc_message_3_extracted_fields_result;
  }
  return tst_srv_edhoc_message_3_extract_stub_extract_result;
}
...
bool edhoc_connection_id_equal(const struct edhoc_connection_id* conn_id_1,
  ...
  (void)conn_id_1;
  (void)conn_id_2;
  return tst_srv_edhoc_message_3_extract_stub_equal_result;
}
