  ...
  for (size_t i = 0; i < test_length; i++) {
    ...
    const struct cli_edhoc_responder_preferred_suites_result result =
        cli_edhoc_get_responder_preferred_suites(
            get_cipher_suites_0_2_dummy_list(), initial_preferred_suites,
            test_buffer);
...
void test_prioritize_initiator_suite_preference(void) {
  ...
  const struct cli_edhoc_responder_preferred_suites_result result =
      cli_edhoc_get_responder_preferred_suites(
          own_supported_suites, initial_preferred_suites, test_buffer);
...
void test_gives_no_suites_when_negotiation_cannot_be_made(void) {
  const struct cli_edhoc_responder_preferred_suites_result result =
      cli_edhoc_get_responder_preferred_suites(
          get_cipher_suites_0_2_dummy_list(), PREFER_DUMMY_CIPHER_SUITE,
          ONLY_SUITE_3_BUFFER);
...
void test_fails_on_invalid_data(void) {
  ...
  for (size_t i = 0; i < test_length; i++) {
    const struct cli_edhoc_responder_preferred_suites_result result =
        cli_edhoc_get_responder_preferred_suites(
            test_cases[i].supported_suites,
            test_cases[i].initial_preferred_suites, test_cases[i].buffer);
...
void test_fails_when_error_process_fails(void) {
  ...
  const struct cli_edhoc_responder_preferred_suites_result result =
      cli_edhoc_get_responder_preferred_suites(
          COM_EDHOC_ONLY_SUITE_0, DUMMY_SUITE_LIST, ONLY_SUITE_3_BUFFER);
